...
describe('API Endpoint /rides', () => {
  ...
  it('should return all rides', (done) => {
    chai.request(app)
      .get('/api/v1/rides?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjAsIm5hbWUiOiJUcmF2aXMgTm9kZWpzIiwiaWF0IjoxNTMyMTQ4MDAxLCJleHAiOjE1MzIyMzQ0MDF9.iuEQCNmW6JwsfvQvgBivoyNt9vp8Ci507QDKTRplL_8')
      .end((err, res) => {
        expect(res).to.have.status(200);
        expect(res).to.be.json;
        expect(res.body).to.be.an('object');
  ...
  it('should post a new ride', (done) => {
    ...
    chai.request(app)
      .post('/api/v1/rides?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjAsIm5hbWUiOiJUcmF2aXMgTm9kZWpzIiwiaWF0IjoxNTMyMTQ4MDAxLCJleHAiOjE1MzIyMzQ0MDF9.iuEQCNmW6JwsfvQvgBivoyNt9vp8Ci507QDKTRplL_8')
      .send(ride)
      .end((err, res) => {
  ...
  it('should get a specific ride offer', (done) => {
    chai.request(app)
      .get('/api/v1/rides/6?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjAsIm5hbWUiOiJUcmF2aXMgTm9kZWpzIiwiaWF0IjoxNTMyMTQ4MDAxLCJleHAiOjE1MzIyMzQ0MDF9.iuEQCNmW6JwsfvQvgBivoyNt9vp8Ci507QDKTRplL_8')
      .end((err, res) => {
        expect(res).to.have.status(200);
        expect(res).to.be.json;
        expect(res.body).to.be.an('object');
  ...
  it('should get all request for a ride offer', (done) => {
    chai.request(app)
      .get('/api/v1/users/rides/5/requests?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjAsIm5hbWUiOiJUcmF2aXMgTm9kZWpzIiwiaWF0IjoxNTMyMTQ4MDAxLCJleHAiOjE1MzIyMzQ0MDF9.iuEQCNmW6JwsfvQvgBivoyNt9vp8Ci507QDKTRplL_8')
      .end((err, res) => {
        expect(res).to.have.status(201);
        expect(res).to.be.json;
        expect(res.body).to.be.an('object');
  ...
  it('should respond to a ride offer', (done) => {
    chai.request(app)
      .put('/api/v1/users/rides/5/requests/3?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjAsIm5hbWUiOiJUcmF2aXMgTm9kZWpzIiwiaWF0IjoxNTMyMTQ4MDAxLCJleHAiOjE1MzIyMzQ0MDF9.iuEQCNmW6JwsfvQvgBivoyNt9vp8Ci507QDKTRplL_8')
      .end((err, res) => {
        expect(res).to.be.json;
        expect(res.body).to.be.an('object');
        done();
  ...
  it('should make a request to join a ride offer', (done) => {
    chai.request(app)
      .post('/api/v1/rides/1/requests?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjAsIm5hbWUiOiJUcmF2aXMgTm9kZWpzIiwiaWF0IjoxNTMyMTQ4MDAxLCJleHAiOjE1MzIyMzQ0MDF9.iuEQCNmW6JwsfvQvgBivoyNt9vp8Ci507QDKTRplL_8')
      .end((err, res) => {
        expect(res).to.have.status(200);
        expect(res).to.be.json;
        expect(res.body).to.be.an('object');
  ...
  it('should not get any ride offer', (done) => {
    chai.request(app)
      .get('/api/v1/rides/100000?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjAsIm5hbWUiOiJUcmF2aXMgTm9kZWpzIiwiaWF0IjoxNTMyMTQ4MDAxLCJleHAiOjE1MzIyMzQ0MDF9.iuEQCNmW6JwsfvQvgBivoyNt9vp8Ci507QDKTRplL_8')
      .end((err, res) => {
